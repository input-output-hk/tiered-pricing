...
To ensure correct accounting, the credit to `feeChangeAccount` appears in the produced/consumed 
calculation as a separate item, 
rather than included in the other debits and credits the transaction is making to/from accounts. 

Any Plutus script run by the transaction would not have access to the amount of change 
given to the change account address. A Plutus script is aware of the fixed debits and credits 
made by the tx to accounts, but it does not have access to the accounts' totals. So, being oblivious 
to the missing fee change credit should not affect the outcome of script validation locally vs. 
at block-application time. The script cannot treat the fee change as satisfaction of any 
of its constraints, since it is not shown the fee change amount. 
...
Manifests, runners, and the pinned evaluator: [cert-void-smoke.json](../../../abstract-sim-hs/config/sweeps/cert-void-smoke.json), [void-size-sweep.json](../../../abstract-sim-hs/config/sweeps/void-size-sweep.json), [void-size-sweep-low.json](../../../abstract-sim-hs/config/sweeps/void-size-sweep-low.json), [cert-void-confirm.json](../../../abstract-sim-hs/config/sweeps/cert-void-confirm.json), and [run_cert_void_confirm.sh](../../../abstract-sim-hs/scripts/run_cert_void_confirm.sh). `scripts/compare_cert_void_confirm.py` regenerates the confirmation report and verifies the pre-registered plan.
...
Manifests and runners: [announcement-semantics-smoke.json](../../../abstract-sim-hs/config/sweeps/announcement-semantics-smoke.json), [standard-window-screen.json](../../../abstract-sim-hs/config/sweeps/standard-window-screen.json), [standard-window-adoption-confirm.json](../../../abstract-sim-hs/config/sweeps/standard-window-adoption-confirm.json), [recommended-headlines.json](../../../abstract-sim-hs/config/sweeps/recommended-headlines.json), [cert-qualification-smoke.json](../../../abstract-sim-hs/config/sweeps/cert-qualification-smoke.json), and the matching `run_*.sh` scripts and `compare_*.py` evaluators in `abstract-sim-hs/scripts/`. The confirmation evaluator checks the declared criteria mechanically. Preserved records, each with its comparison-time source patch alongside: [announcement-semantics-smoke.json](../experiment-results/announcement-semantics-smoke.json), [standard-window-screen.json](../experiment-results/standard-window-screen.json), [standard-window-adoption-confirm.json](../experiment-results/standard-window-adoption-confirm.json), [recommended-headlines.json](../experiment-results/recommended-headlines.json), and [cert-qualification-smoke.json](../experiment-results/cert-qualification-smoke.json).
