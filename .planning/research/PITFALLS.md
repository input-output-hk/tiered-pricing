...
- [Foundations of Transaction Fee Mechanism Design (Chung & Shi, SODA'23)](https://eprint.iacr.org/2021/1474) — impossibility result for user-IC + miner-IC + side-contract-proofness; precedent for MOD-3 (adversarial-case disclosure) and for keeping anti-bribery / incentive properties separate from welfare in CRIT-2
