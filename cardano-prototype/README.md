...
From this folder, after a recursive clone. Prerequisites: **nix** (with
flakes), ~16 GB RAM, macOS or Linux.
...
This prototype backs the [Transaction Urgency Signalling CIP](../docs/phase-2/CIP-urgency-signalling/README.md).
